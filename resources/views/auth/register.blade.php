    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" @isset($user->type) action="{{ route('technician.show.add') }}"  @else action="{{ route('register') }}"  @endisset>
                        @csrf

                        <div class="form-group row">
                            <label for="id" class="col-md-4 col-form-label text-md-right">ID/Student number</label>
